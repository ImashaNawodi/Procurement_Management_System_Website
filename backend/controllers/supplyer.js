...
exports.create = async (req,res) =>{
    const {username,supplierName, supplierId,emails, address,contactOfficer,contactNumbers,faxNumber,typeofBusiness,classOfAssets} = req.body;
// response will send to frontend
const newSupplyer= new Supplyer({username,supplierName, supplierId,emails, address,contactOfficer,contactNumbers,faxNumber,typeofBusiness,classOfAssets})
